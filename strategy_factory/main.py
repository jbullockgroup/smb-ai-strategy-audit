...
""",
        ...
        run_parser.add_argument(
            "--skip-generation",
            action="store_true",
            help="Skip final document generation (DOCX, PDF)",
        )
        run_parser.add_argument(
            "--verbose", "-v",
            action="store_true",
    ...
    def cmd_run(self, args) -> int:
        ...
        # Dry run mode
        if args.dry_run:
            return self._dry_run(company_name, args.context, args.industry)
        ...
        try:
            ...
            if not args.skip_research:
                research_output = self._run_research(tracker, company_input)
    ...
    def cmd_resume(self, args) -> int:
        ...
        try:
            ...
            final_deliverables = ["final_strategy_report", "final_strategy_report_pdf"]
    ...
    def _dry_run(
        ...
        print(f"    │   └── final_strategy_report.pdf")
        print(f"    ├── state.json")
